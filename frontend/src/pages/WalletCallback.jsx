...
export default function WalletCallback() {
  ...
  return (
    <div className="max-w-md mx-auto px-5 py-24 text-center">
      {state === "checking" && (
        <>
          <div className="font-mono text-xs text-slate mb-3">CONFIRMING TOP-UP</div>
      ...
      {state === "success" && (
        <>
          <div className="font-mono text-xs text-delivered mb-3">TOP-UP SUCCESSFUL</div>
          <h1 className="font-display text-2xl font-semibold mb-2">Wallet funded 🎉</h1>
          {balance !== null && (
            <p className="text-slate text-sm mb-6">Your new balance is <span className="font-mono font-semibold text-ink">₦{balance.toLocaleString()}</span>.</p>
          )}
      ...
      {state === "failed" && (
        <>
          <div className="font-mono text-xs text-red-600 mb-3">TOP-UP NOT COMPLETED</div>
      ...
      {state === "error" && (
        <>
          ...
          <h1 className="font-display text-2xl font-semibold mb-2">We couldn't confirm this top-up</h1>
