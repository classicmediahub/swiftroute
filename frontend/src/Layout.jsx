...
//
// LaunchGate has been removed now that the site has actually launched —
// it served its purpose (a pre-launch "coming soon" screen for
// logged-out visitors) and is no longer needed. See git history if a
// future soft-launch/gated-rollout ever needs the same pattern again.
